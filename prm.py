    ...
    if missing_param == 'vcd': # VERTICAL DISTANCE MISSING
        ...
        while True:  # ACCELERATION DUE TO GRAVITY
            try:
                ...
                print('incorrect value, try again: ')
        distance_vertical = (velocity_initial_vertical**2) * math.sin(init_angle_rad_flt)**2 / 2 * adg_flt
        discrim_time = (velocity_initial_vertical ** 2) + (2 * adg_flt * distance_vertical)
        ...
        print('the solutions to the quadratic are:', round(sol_time_2, 3), 'seconds', 'and', round(sol_time_1, 3), 'seconds')
